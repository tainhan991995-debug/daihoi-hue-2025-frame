    ...
    <div className="min-h-screen p-10 bg-[#cfe4ff] flex flex-col items-center">
      ...
      <div className="max-w-[1800px] w-full grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-10">
        ...
        <div className="bg-white p-10 rounded-2xl shadow-xl">
          ...
          <input className="form-input" placeholder="Nhập họ và tên…" onChange={(e) => setName(e.target.value)} />

          <div className="label-box mt-4">Chức vụ - Đơn vị</div>
          <input className="form-input" placeholder="Nhập chức vụ - đơn vị…" onChange={(e) => setRoleUnit(e.target.value)} />

          <div className="label-box mt-4">Gửi lời nhắn</div>
          <textarea className="form-input" placeholder="Nhập lời nhắn…" maxLength={500} rows={6} onChange={(e) => setMessage(e.target.value)} />
